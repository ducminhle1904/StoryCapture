...
export default function SettingsRoute() {
  return (
    ...
    >
      <header className="brand-panel relative overflow-hidden rounded-[34px] px-7 py-7">
        <div className="absolute inset-y-0 right-0 w-[34%] bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.14),transparent_62%)] opacity-60" />
        <div className="absolute inset-x-0 top-0 h-24 bg-[radial-gradient(circle_at_top_left,rgba(255,106,124,0.18),transparent_58%)]" />
        <div className="relative grid gap-8 xl:grid-cols-[minmax(0,1.2fr)_320px]">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h1 className="mt-3 max-w-3xl text-4xl font-semibold tracking-[-0.055em] text-white">
          ...
          <aside className="rounded-[28px] border border-white/10 bg-black/18 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
