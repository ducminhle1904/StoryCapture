            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <Dialog.Description className="font-serif mt-2 text-sm leading-6 text-[var(--color-fg-secondary)]">
                  {appName} needs macOS Screen Recording access to record your browser demos. You
                  only have to grant it once — the app will relaunch so the new permission takes
                  effect.
                </Dialog.Description>
              </div>
            </div>
