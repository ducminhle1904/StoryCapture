...
if (process.platform !== "darwin" || process.arch !== "arm64") {
  console.error("Recording V3 Strict Local development requires macOS on Apple silicon.");
  process.exit(1);
}
...
const strictLocal = await run(["electron:dev"]);
process.exit(strictLocal.code);
