...
/**
 * Template card for the marketplace grid.
 * Shows name, description, category badge, fork count, and "Use Template" button.
 */
...
export function TemplateCard({
  ...
  const colors = CATEGORY_COLORS[category] ?? CATEGORY_COLORS.CLI_TOOL!;
  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900 transition-all duration-200 hover:scale-[1.02] hover:border-zinc-700 hover:shadow-lg hover:shadow-zinc-950/50">
      ...
      <div
        className={`flex h-32 items-center justify-center bg-gradient-to-br ${colors.gradient}`}
      >
