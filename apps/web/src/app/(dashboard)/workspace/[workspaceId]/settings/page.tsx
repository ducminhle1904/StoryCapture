...
export default function WorkspaceSettingsPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-zinc-50">Workspace Settings</h1>
      ...
      <section className="rounded-xl border border-zinc-800 bg-zinc-900 p-5">
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="ws-name" className="mb-1 block text-xs text-zinc-500">
              Workspace name
            </label>
            <input
              id="ws-name"
          ...
          <div>
            <label htmlFor="ws-slug" className="mb-1 block text-xs text-zinc-500">
              Slug
            </label>
            <input
              id="ws-slug"
              ...
              className="w-full max-w-md rounded-lg border border-zinc-700 bg-zinc-800 px-3 py-2 text-sm text-zinc-200 placeholder:text-zinc-600 focus:border-zinc-600 focus:outline-none disabled:opacity-50"
            />
            <p className="mt-1 text-xs text-zinc-600">Lowercase alphanumeric and hyphens only.</p>
          </div>
          ...
          {updateMutation.isSuccess && <p className="text-sm text-green-400">Settings updated.</p>}
        </div>
      </section>
