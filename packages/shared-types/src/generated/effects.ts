 ...
 */
export type VideoNode = { "type": "source", id: NodeId, path: string, pts_offset_ms: bigint, } | { "type": "zoom-pan", id: NodeId, target: ZoomTarget, keyframes: Array<ZoomKeyframe>, } | { "type": "background", id: NodeId, kind: BackgroundKind, radius_px: number, shadow: Shadow | null, } | { "type": "cursor-overlay", id: NodeId, skin: CursorSkin, size_scale: number, color_tint: Rgba | null, trajectory: TrajectoryRef, } | { "type": "ripple-overlay", id: NodeId, events: Array<RippleEvent>, } | { "type": "text-overlay", id: NodeId, boxes: Array<TextBox>, } | { "type": "transition", id: NodeId, kind: XfadeKind, duration_ms: number, offset_ms: number, };
