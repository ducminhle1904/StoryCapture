...
- `packages/shared-types/src/{recording-v2,recording-v3}.ts` are the
  hand-maintained JSON-safe Recording V2/V3 contracts. They are public from the
  root barrel and the `@storycapture/shared-types/recording-v2` runtime-safe
  subpath.
