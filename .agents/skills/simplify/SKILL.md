---
name: 'simplify'
description: Simplify recently changed code by removing duplication, reusing existing helpers, flattening awkward logic, and trimming unnecessary work. Use when the user asks to simplify, clean up, refactor, deduplicate, or make a change smaller/clearer.
metadata:
  short-description: Simplify changed code
---
